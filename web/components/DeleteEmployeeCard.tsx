...
const DeleteEmployeeCard = () => {
    ...
    // Debug logging
    console.log("DeleteEmployeeCard - employees:", employees);
    console.log("DeleteEmployeeCard - isLoading:", isLoading);
    console.log("DeleteEmployeeCard - error:", error);
                        ...
                        <table className="w-full border-t border-border">
                            ...
                            <tbody>
                                {isLoading ? (
                                    ...
                                    <tr>
                                        <td colSpan={4} className="px-4 py-6 text-center text-muted-foreground">
                                            No employees to delete. Add employees first.
                                        </td>
                                    </tr>
                                ) : (
                                    employees.map((e) => (
                                        <tr key={e.id} className="border-t border-border">
                                            ...
                                            <td className="px-4 py-3 align-middle">
                                                <div className="flex items-center justify-end">
                                                    <EmployeeDeleteDialog employee={e} />
                                                </div>
                                            </td>
                                        </tr>
                                    ))
